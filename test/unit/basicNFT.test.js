...
!developmentChains.includes(network.name)? describe.skip : describe("BasicNFt tests",function(){
    ...
    describe("mints nft",function(){
        ...
        it("mints nft and updates counter",async ()=>{
            ...
            const uri = await basicNFT.tokenURI(ethers.utils.parseEther(t.toString()))
